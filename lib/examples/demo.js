...
var _opentracingNodeDebug = require('opentracing/dist/opentracing-node-debug.js');

var _opentracingNodeDebug2 = _interopRequireDefault(_opentracingNodeDebug);
...
_opentracingNodeDebug2.default.initGlobalTracer(_lightstepTracer2.default.tracer({
    access_token: '{your_access_token}',
    component_name: 'node/promises'
}));

// Set up an initial span to track all the subsequent work
var parent = _opentracingNodeDebug2.default.startSpan('Promises.all');
